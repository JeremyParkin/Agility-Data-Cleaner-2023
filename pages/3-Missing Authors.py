...
if not st.session_state.upload_step:
    ...
    def fixable_headline_stats(df, primary="Headline", secondary="Author"):
        ...
        stats = (
            ...
            f"Fixable Fields: \t{fixable}\nUnique Fixable: \t{fixable_headline_count}\n"
            f"Percent knowable: \t{percent_knowable}")
        return stats
    ...
    with col3:
        ...
        stats = (fixable_headline_stats(st.session_state.df_traditional, primary="Headline", secondary="Author"))
        st.text(stats)
