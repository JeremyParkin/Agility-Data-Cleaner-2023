...
#     client_name: str,
#     max_files: int = 50,
#     max_rows_per_file: int = 500,          # NEW: row cap per file
#     max_words_per_file: int = 120_000,     # LOWER than the theoretical 500k
#     max_bytes_per_file: int = 25 * 1024 * 1024,  # ~25 MB
#     text_truncate_len: int = 10_000
# ):
#     """
...
#             traditional["Tags"].str.get_dummies(sep=",").astype('category'),
#             how='left',
#             rsuffix=' (tag)'
#         )
#
...
#         social = social.join(
#             social["Tags"].str.get_dummies(sep=",").astype('category'),
#             how='left',
#             rsuffix=' (tag)'
#         )
#
#     # ---------- Cleaned workbook form ----------
#
...
#                     st.session_state.df_dupes = st.session_state.df_dupes.rename(
#                         columns={'AVE': st.session_state.ave_col[0]}
#                     )
#                     st.session_state.df_dupes.to_excel(
#                         writer,
#                         sheet_name='DLTD DUPES',
#                         header=True,
#                         index=False
...
#
#                 # RAW (untouched)
#                 st.session_state.df_untouched = st.session_state.df_untouched.rename(
#                     columns={'AVE': st.session_state.ave_col[0]}
#                 )
#                 st.session_state.df_untouched.drop(
#                     ["Mentions"],
#                     axis=1,
#                     inplace=True,
#                     errors='ignore'
#                 )
#                 st.session_state.df_untouched.to_excel(
#                     writer,
#                     sheet_name='RAW',
#                     header=True,
#                     index=False
